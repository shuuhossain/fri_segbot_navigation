...
if("TRUE" STREQUAL "TRUE")
  set(skeleton_markers_SOURCE_PREFIX /home/fri/catkin_ws_shsl/src/skeleton_markers)
  set(skeleton_markers_DEVEL_PREFIX /home/fri/catkin_ws_shsl/devel)
  ...
  set(skeleton_markers_INSTALL_PREFIX /home/fri/catkin_ws_shsl/install)
...
if(NOT "/home/fri/catkin_ws_shsl/devel/include" STREQUAL "")
  set(skeleton_markers_INCLUDE_DIRS "")
  set(_include_dirs "/home/fri/catkin_ws_shsl/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'skeleton_markers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/fri/catkin_ws_shsl/src/skeleton_markers/${idir}'.  Ask the maintainer 'Patrick Goebel <patrick@pirobot.org>' to fix it.")
    endif()
